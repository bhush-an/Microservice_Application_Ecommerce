...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(QuantityNotMentionedException.class)
    public ResponseEntity<ResponseDTO> handleQuantityNotMentionedException(QuantityNotMentionedException e) {
        ResponseDTO response = ResponseDTO.builder()
                .errorMessage(e.getMessage())
                .build();
